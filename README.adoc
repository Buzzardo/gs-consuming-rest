...
We recommend using the Spring Initializr to get started with this project. To do so:

. Go to https://start.spring.io and choose `Web` as the only dependency.
. Set the project metadata (*Group*, *Artifact*, *Name*, *Description*, and possibly other
values) to suit your needs.
. Click *Generate Project*.

For this example, we set the *Group* to "hello", the *Artifact* to "consuming-rest-service",
the *Name* to empty, the *Description* to "Consuming a Restful Web Service", and the
*Package Name* to "hello".

The Spring Initializr creates a zip file that you can download and unzip in the directory
you want to use for your project.

NOTE: The Spring Initializr can create either Maven or Gradle projects. This guide supports
both.
...
NOTE: The Spring Initializr creates a file called `Application.Java` for you. For this guide, we need to replace it.
...
NOTE: The Spring Initializr creates a file called `Application.Java` for you. For this guide to work, we need to replace it.
...
This guide is on the file://c:/spring/demo/trails/trails.html#trails-rest[REST] trail.
file://c:/spring/demo/gs-rest-service/README.html[Previous topic].
file://c:/spring/demo/gs-rest-service-cors/README.html[Next topic].
